...
1. Get "stackbit-deploy (Read+Write)" API token from your [Sanity management console](https://manage.sanity.io/projects/b2nbllp8/settings/api)
...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/sanity-pull --ssg gatsby --sanity-project-id b2nbllp8 --sanity-token $SANITY_ACCESS_TOKEN
...
To start editing your site, you can use the Sanity interface at https://unique-sun-51122.sanity.studio/.
...
Generated at `2021-05-31T16:39:22.561Z` by Stackbit version `0.3.53`.